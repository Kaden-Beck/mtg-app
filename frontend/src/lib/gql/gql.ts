...
type Documents = {
    ...
    "query GetCollection {\n  collection {\n    id\n    scryfallId\n    quantity\n    foil\n    condition\n    language\n    purchasePriceCents\n    card {\n      id\n      name\n      setName\n      priceUsd\n      priceUsdFoil\n      imageUris\n    }\n  }\n}\n\nmutation AddToCollection($scryfallId: String!, $quantity: Int, $foil: Boolean, $condition: String) {\n  addToCollection(\n    scryfallId: $scryfallId\n    quantity: $quantity\n    foil: $foil\n    condition: $condition\n  ) {\n    id\n    scryfallId\n    quantity\n  }\n}": typeof types.GetCollectionDocument,
    "query CardByCollectorNumber($setCode: String!, $collectorNumber: String!) {\n  cardByCollectorNumber(setCode: $setCode, collectorNumber: $collectorNumber) {\n    id\n    name\n    setCode\n    setName\n    collectorNumber\n    rarity\n    priceUsd\n    priceUsdFoil\n    imageUris\n  }\n}": typeof types.CardByCollectorNumberDocument,
};
const documents: Documents = {
    "mutation ConvertCsv($csv: String!, $fromFormat: CollectionFormat!, $toFormat: CollectionFormat!) {\n  convertCsv(csv: $csv, fromFormat: $fromFormat, toFormat: $toFormat) {\n    csv\n    count\n  }\n}": types.ConvertCsvDocument,
    "query SearchCards($query: String!, $limit: Int) {\n  searchCards(query: $query, limit: $limit) {\n    id\n    name\n    setCode\n    setName\n    manaCost\n    cmc\n    typeLine\n    colorIdentity\n    rarity\n    priceUsd\n    priceUsdFoil\n    imageUris\n  }\n}\n\nquery CardById($id: String!) {\n  cardById(id: $id) {\n    id\n    name\n    oracleText\n    legalities\n    imageUris\n  }\n}": types.SearchCardsDocument,
    "query GetCollection {\n  collection {\n    id\n    scryfallId\n    quantity\n    foil\n    condition\n    language\n    purchasePriceCents\n    card {\n      id\n      name\n      setName\n      priceUsd\n      priceUsdFoil\n      imageUris\n    }\n  }\n}\n\nmutation AddToCollection($scryfallId: String!, $quantity: Int, $foil: Boolean, $condition: String) {\n  addToCollection(\n    scryfallId: $scryfallId\n    quantity: $quantity\n    foil: $foil\n    condition: $condition\n  ) {\n    id\n    scryfallId\n    quantity\n  }\n}": types.GetCollectionDocument,
    "query CardByCollectorNumber($setCode: String!, $collectorNumber: String!) {\n  cardByCollectorNumber(setCode: $setCode, collectorNumber: $collectorNumber) {\n    id\n    name\n    setCode\n    setName\n    collectorNumber\n    rarity\n    priceUsd\n    priceUsdFoil\n    imageUris\n  }\n}": types.CardByCollectorNumberDocument,
};
 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "query GetCollection {\n  collection {\n    id\n    scryfallId\n    quantity\n    foil\n    condition\n    language\n    purchasePriceCents\n    card {\n      id\n      name\n      setName\n      priceUsd\n      priceUsdFoil\n      imageUris\n    }\n  }\n}\n\nmutation AddToCollection($scryfallId: String!, $quantity: Int, $foil: Boolean, $condition: String) {\n  addToCollection(\n    scryfallId: $scryfallId\n    quantity: $quantity\n    foil: $foil\n    condition: $condition\n  ) {\n    id\n    scryfallId\n    quantity\n  }\n}"): (typeof documents)["query GetCollection {\n  collection {\n    id\n    scryfallId\n    quantity\n    foil\n    condition\n    language\n    purchasePriceCents\n    card {\n      id\n      name\n      setName\n      priceUsd\n      priceUsdFoil\n      imageUris\n    }\n  }\n}\n\nmutation AddToCollection($scryfallId: String!, $quantity: Int, $foil: Boolean, $condition: String) {\n  addToCollection(\n    scryfallId: $scryfallId\n    quantity: $quantity\n    foil: $foil\n    condition: $condition\n  ) {\n    id\n    scryfallId\n    quantity\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "query CardByCollectorNumber($setCode: String!, $collectorNumber: String!) {\n  cardByCollectorNumber(setCode: $setCode, collectorNumber: $collectorNumber) {\n    id\n    name\n    setCode\n    setName\n    collectorNumber\n    rarity\n    priceUsd\n    priceUsdFoil\n    imageUris\n  }\n}"): (typeof documents)["query CardByCollectorNumber($setCode: String!, $collectorNumber: String!) {\n  cardByCollectorNumber(setCode: $setCode, collectorNumber: $collectorNumber) {\n    id\n    name\n    setCode\n    setName\n    collectorNumber\n    rarity\n    priceUsd\n    priceUsdFoil\n    imageUris\n  }\n}"];
